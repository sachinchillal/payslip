...
import { deleteEmployee, saveOrUpdateEmployee, savePayslipData } from '@/store/setters';
import React, { useState, useEffect } from 'react';
import ReactMarkdown from 'react-markdown';
import remarkGfm from 'remark-gfm'

const sample = `Employee Id: COM/300
Name: **Shashi Kumar**
DOJ: 1-Jan-2025
Designation: Senior Software Engineer
Mode of payment: Net banking
Work mode: *Hybrid*
A/C: BANK03 / 010062025`.split("\n").join("\n\n");
const sample2 = "```\n" +
  `Employee Id    :  COM/300
Name           :  Shashi Kumar
DOJ            :  1-Jan-2025
...
export default function CompanyDetailsEditor() {
  ...
  const init = () => {
    ...
    setCompanies(p.employees);
    setSelectedCompany(p.employees.find(c => c.isSelected) || null);
  }
  ...
  const handleSaveDetails = () => {
    const res = saveOrUpdateEmployee(companyDetails, companyLabel, companyId);
  ...
  const handleViewSample = () => {
    ...
    setCompanyLabel('Sample Employee Details');
    showStatus("Sample Employee details loaded.", "success");
  };
  const handleViewSample2 = () => {
    resetVariables();
    setCompanyDetails(sample2);
    setCompanyLabel('Sample Employee Details 2');
    showStatus("Sample Employee details loaded.", "success");
  };
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-4 sm:p-6 lg:p-8 font-sans">
      <div className="tmax-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
            <h2 className="text-xl font-semibold mb-4 text-gray-700 dark:text-gray-300">
              {editingCompanyIndex !== null ? `Editing Employee #${editingCompanyIndex + 1}` : 'Enter Employee Details (Markdown)'}
            </h2>
            ...
            <textarea
              ...
              placeholder="Enter Employee details here. Use Markdown for formatting..."
              rows={15}
        ...
        <div className="mt-12 bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow-lg">
          ...
          {companies.length === 0 ? (
            <p className="text-gray-500 dark:text-gray-400">No employees details saved yet.</p>
          ) : (
                    ...
                    >
                      <td className="px-4 py-3 whitespace-nowrap">
                        <input
                          ...
                          aria-label={`Select Employee ${index + 1}`}
                        />
                      </td>
